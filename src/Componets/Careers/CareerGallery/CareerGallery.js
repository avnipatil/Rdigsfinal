        ...
        <>
            <section>          
                <div class="container">
                    ...
                    <div className="row">
                        <div className="col-md-8 col-sm-12 co-xs-12 gal-item"data-aos="zoom-in">
                            <div className="row h-50">
                                <div className="col-md-12 col-sm-12 co-xs-12 gal-item"data-aos="zoom-in">
                            ...
                            <div className="row h-50 cargalrow3">
                                <div className="col-md-6 col-sm-6 co-xs-12 gal-item"data-aos="zoom-in">
                                    <div className="careerculbox">
                        ...
                        <div className="col-md-4 col-sm-6 co-xs-12 gal-item"data-aos="zoom-in">
                            <div className="col-md-12 col-sm-6 co-xs-12 gal-item h-25"data-aos="zoom-in">
                                <div className="careerculbox">
                                    <img src={culture4} className="img-ht img-fluid rounded" alt=""/>
                                </div>
                            </div>

                            <div className="col-md-12 col-sm-6 co-xs-12 gal-item h-75"data-aos="zoom-in">
                                <div className="careerculbox">
