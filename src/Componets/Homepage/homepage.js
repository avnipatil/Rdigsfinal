          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                <h1 style={{color:'#6cbeee'}}>Don't Miss New Updates</h1>
                <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                  <input type="email" id="email" {...register("email")} placeholder="Enter your E-Mail Here " className="homemodalinput" required /> 
